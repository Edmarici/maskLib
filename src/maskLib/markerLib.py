...
def MarkerCross_global(
    ...
    **kwargs
    ...
    w.add(
        dxf.rectangle(
            vadd(pos, (0, linewidth / 2)),
            linewidth,
            size[1] / 2 - linewidth / 2,
            valign=const.TOP,
            halign=const.CENTER,
            bgcolor=bgcolor,
            layer=layer,
...
alphanum_dict = {
    "a": [
        [(0, 0), (0, 16), (12, 16), (12, 0), (8, 0), (8, 14), (4, 14), (4, 0), (0, 0)],
        [(4, 8), (4, 10), (8, 10), (8, 8), (4, 8)],
    ],
    "b": [
        [(0, 0), (4, 0), (4, 16), (0, 16), (0, 0)],
        [
            (4, 0),
            (8, 0),
            (12, 2),
    ...
    "o": [
        [(0, 0), (4, 0), (4, 16), (0, 16), (0, 0)],
        [(4, 0), (12, 0), (12, 16), (4, 16), (4, 14), (8, 14), (8, 2), (4, 2), (4, 0)],
    ],
    "p": [
        [(0, 0), (4, 0), (4, 16), (0, 16), (0, 0)],
        [
    ...
    "r": [
        [(0.0, 0.0), (4.0, 0.0), (4.0, 16.0), (0.0, 16.0), (0.0, 0.0)],
        [
            (4.0, 8.0),
            (8.0, 0.0),
            (12.0, 0.0),
    ...
    "v": [
        [(4, 0), (8, 0), (12, 16), (8, 16), (6, 6), (4, 16), (0, 16), (4, 0), (4, 0)]
    ],
    "w": [
        [
            (0, 0),
    ...
    "0": [
        ...
        [(4, 2), (6, 2), (8, 13), (8, 14), (6, 14), (4, 3), (4, 2)],
    ],
    "1": [
        [
            (0, 0),
    ...
    "6": [
        [(0, 0), (4, 0), (4, 16), (0, 16), (0, 0)],
        [(4, 0), (12, 0), (12, 8), (4, 8), (4, 6), (8, 6), (8, 2), (4, 2), (4, 0)],
    ],
    "7": [[(8, 0), (12, 0), (12, 16), (0, 16), (0, 14), (8, 14), (8, 0), (8, 0)]],
    "8": [
        [(0, 0), (4, 0), (4, 16), (0, 16), (0, 10), (4, 8), (0, 6), (0, 0)],
        [
            (4, 0),
            (12, 0),
            (12, 6),
    ...
    "9": [
        [(8, 0), (12, 0), (12, 16), (8, 16), (8, 0)],
        [(8, 16), (0, 16), (0, 8), (8, 8), (8, 10), (4, 10), (4, 14), (8, 14), (8, 16)],
    ],
    "+": [
        [
            (0, 6),
